 ...
 * @author Khloe Lai
 */
public class Deliverydetails1 extends javax.swing.JFrame {

    /**
     * Creates new form delstaffdetails
     */
    public Deliverydetails1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Type of transport:");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Motorcycle", "Lorry", "Van", "Car" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pending", "On Hold ", "Delivered" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deliverydetails1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deliverydetails1().setVisible(true);
            }
        });
    }
